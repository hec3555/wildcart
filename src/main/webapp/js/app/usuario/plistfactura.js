...
moduleUsuario.controller('usuarioPlistFacturaController', ['$scope', 'toolService', '$http', '$routeParams', '$location', 'pdfService',
    function ($scope, toolService, $http, $routeParams, $location, pdfService) {
        $scope.ob = "usuario";
        $scope.totalPages = 1;
